...
ITEM_CATALOG: dict[ItemName, ItemConfig] = {
    ...
    ItemName.OIL_SANDS_CRUDE:    ItemConfig(ItemName.OIL_SANDS_CRUDE,    Category.ENERGY,  80.0, 0.080, 0.04, 1.50),
    ItemName.NATURAL_GAS:        ItemConfig(ItemName.NATURAL_GAS,        Category.ENERGY,  45.0, 0.090, 0.04, 1.60),
    ItemName.REFINED_BITUMEN:    ItemConfig(ItemName.REFINED_BITUMEN,    Category.ENERGY,  95.0, 0.070, 0.03, 1.40),
    ItemName.SOLAR_PANELS:       ItemConfig(ItemName.SOLAR_PANELS,       Category.ENERGY, 120.0, 0.060, 0.03, 1.20),
    ItemName.WIND_TURBINE_PARTS: ItemConfig(ItemName.WIND_TURBINE_PARTS, Category.ENERGY, 110.0, 0.060, 0.03, 1.20),
    ItemName.HYDROGEN_CELLS:     ItemConfig(ItemName.HYDROGEN_CELLS,     Category.ENERGY, 155.0, 0.085, 0.04, 1.45),
    ItemName.GEOTHERMAL_CREDITS: ItemConfig(ItemName.GEOTHERMAL_CREDITS, Category.ENERGY,  60.0, 0.055, 0.04, 1.10),
    ItemName.CARBON_OFFSETS:     ItemConfig(ItemName.CARBON_OFFSETS,     Category.ENERGY,  38.0, 0.065, 0.05, 1.35),

    # ── Agriculture: stable, seasonal drift, modest news response ─────────────
    ItemName.PRAIRIE_WHEAT: ItemConfig(ItemName.PRAIRIE_WHEAT, Category.AGRICULTURE, 22.0, 0.020, 0.06, 0.80),
    ItemName.CANOLA_OIL:    ItemConfig(ItemName.CANOLA_OIL,    Category.AGRICULTURE, 28.0, 0.020, 0.06, 0.80),
    ItemName.BARLEY:        ItemConfig(ItemName.BARLEY,        Category.AGRICULTURE, 18.0, 0.020, 0.06, 0.80),
    ItemName.HONEY:         ItemConfig(ItemName.HONEY,         Category.AGRICULTURE, 35.0, 0.025, 0.05, 0.70),
    ItemName.BISON_MEAT:    ItemConfig(ItemName.BISON_MEAT,    Category.AGRICULTURE, 42.0, 0.030, 0.05, 0.90),
    ItemName.LENTILS:       ItemConfig(ItemName.LENTILS,       Category.AGRICULTURE, 20.0, 0.018, 0.06, 0.75),
    ItemName.PEA_PROTEIN:   ItemConfig(ItemName.PEA_PROTEIN,   Category.AGRICULTURE, 50.0, 0.030, 0.05, 0.85),
    ItemName.MUSTARD_SEED:  ItemConfig(ItemName.MUSTARD_SEED,  Category.AGRICULTURE, 24.0, 0.022, 0.06, 0.75),

    # ── Tech & AI: trend-driven, strong news correlation ──────────────────────
    ItemName.GPU_CHIPS:        ItemConfig(ItemName.GPU_CHIPS,        Category.TECH_AI, 200.0, 0.070, 0.03, 1.40),
    ItemName.TRAINING_DATA:    ItemConfig(ItemName.TRAINING_DATA,    Category.TECH_AI,  75.0, 0.050, 0.04, 1.20),
    ItemName.AI_MODEL_WEIGHTS: ItemConfig(ItemName.AI_MODEL_WEIGHTS, Category.TECH_AI, 150.0, 0.060, 0.03, 1.30),
    ItemName.ROBOTICS_PARTS:   ItemConfig(ItemName.ROBOTICS_PARTS,   Category.TECH_AI, 180.0, 0.060, 0.03, 1.30),
    ItemName.CLOUD_CREDITS:    ItemConfig(ItemName.CLOUD_CREDITS,    Category.TECH_AI,  55.0, 0.050, 0.04, 1.10),
    ItemName.QUANTUM_ACCESS:   ItemConfig(ItemName.QUANTUM_ACCESS,   Category.TECH_AI, 320.0, 0.090, 0.03, 1.50),
    ItemName.DRONE_COMPONENTS: ItemConfig(ItemName.DRONE_COMPONENTS, Category.TECH_AI, 165.0, 0.065, 0.03, 1.25),
    ItemName.SENSOR_ARRAYS:    ItemConfig(ItemName.SENSOR_ARRAYS,    Category.TECH_AI,  90.0, 0.055, 0.04, 1.15),

    # ── Luxury & Local: illiquid, low drift, premium when available ───────────
    ItemName.ALBERTA_BEEF:          ItemConfig(ItemName.ALBERTA_BEEF,          Category.LUXURY_LOCAL,  65.0, 0.015, 0.02, 0.60),
    ItemName.CRAFT_WHISKY:          ItemConfig(ItemName.CRAFT_WHISKY,          Category.LUXURY_LOCAL,  90.0, 0.015, 0.02, 0.50),
    ItemName.ICE_HOTEL_TICKETS:     ItemConfig(ItemName.ICE_HOTEL_TICKETS,     Category.LUXURY_LOCAL, 250.0, 0.020, 0.02, 0.60),
    ItemName.NORTHERN_LIGHTS_TOURS: ItemConfig(ItemName.NORTHERN_LIGHTS_TOURS, Category.LUXURY_LOCAL, 200.0, 0.020, 0.02, 0.60),
    ItemName.HOCKEY_MEMORABILIA:    ItemConfig(ItemName.HOCKEY_MEMORABILIA,    Category.LUXURY_LOCAL, 140.0, 0.020, 0.02, 0.60),
    ItemName.WILD_GAME_LICENSES:    ItemConfig(ItemName.WILD_GAME_LICENSES,    Category.LUXURY_LOCAL, 185.0, 0.018, 0.02, 0.55),
    ItemName.BUFFALO_HIDE:          ItemConfig(ItemName.BUFFALO_HIDE,          Category.LUXURY_LOCAL, 115.0, 0.018, 0.02, 0.55),
    ItemName.MAPLE_SPIRITS:         ItemConfig(ItemName.MAPLE_SPIRITS,         Category.LUXURY_LOCAL,  78.0, 0.015, 0.02, 0.50),
}
